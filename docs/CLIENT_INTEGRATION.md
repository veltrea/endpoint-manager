...
interface IAIProviderNode {
  id:              string;           // 例: "local-http://192.0.2.22:1234/v1"
  type:            'cloud' | 'local';
  providerType:    ProviderType;
  providerUrl:     string;           // 例: "http://192.0.2.22:1234/v1"
  label?:          string;
...
```json
{ "id": "4", "type": "probe", "endpointId": "local-http://192.0.2.22:1234/v1" }
```
...
```json
{ "id": "7", "type": "add_endpoint", "url": "http://192.0.2.50:1234/v1", "label": "GPU Server" }
```
...
```json
{ "id": "9", "type": "assign_role", "role": "coder", "endpointId": "local-http://192.0.2.22:1234/v1" }
...
- `providerUrl` は OpenAI 互換 API のベース URL（例: `http://192.0.2.22:1234/v1`）
